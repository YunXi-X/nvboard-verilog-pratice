...
VL_INLINE_OPT void Vaddr_4___024root___ico_sequent__TOP__0(Vaddr_4___024root* vlSelf) {
    ...
    // Init
    CData/*1:0*/ __VdfgTmp_hef5a094a__0;
    __VdfgTmp_hef5a094a__0 = 0;
    CData/*1:0*/ __VdfgTmp_ha9918942__0;
    __VdfgTmp_ha9918942__0 = 0;
    CData/*1:0*/ __VdfgTmp_h1b116cf0__0;
    __VdfgTmp_h1b116cf0__0 = 0;
    // Body
    __VdfgTmp_ha9918942__0 = (3U & ((1U & (IData)(vlSelf->a)) 
                                    + ((1U & (IData)(vlSelf->b)) 
                                       + (IData)(vlSelf->cin))));
    __VdfgTmp_h1b116cf0__0 = (3U & ((1U & ((IData)(vlSelf->a) 
                                           >> 1U)) 
                                    + ((1U & ((IData)(vlSelf->b) 
                                              >> 1U)) 
                                       + ((IData)(__VdfgTmp_ha9918942__0) 
                                          >> 1U))));
    __VdfgTmp_hef5a094a__0 = (3U & ((1U & ((IData)(vlSelf->a) 
                                           >> 2U)) 
                                    + ((1U & ((IData)(vlSelf->b) 
                                              >> 2U)) 
                                       + ((IData)(__VdfgTmp_h1b116cf0__0) 
                                          >> 1U))));
    vlSelf->cout = (1U & (((1U & ((IData)(vlSelf->a) 
                                  >> 3U)) + ((1U & 
                                              ((IData)(vlSelf->b) 
                                               >> 3U)) 
                                             + ((IData)(__VdfgTmp_hef5a094a__0) 
                                                >> 1U))) 
                          >> 1U));
    vlSelf->sum = ((8U & ((((IData)(vlSelf->a) >> 3U) 
                   ...
                   ((4U & ((((IData)(vlSelf->a) >> 2U) 
                            + (((IData)(vlSelf->b) 
                                >> 2U) + ((IData)(__VdfgTmp_h1b116cf0__0) 
                                          >> 1U))) 
...
#endif
                VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/addr/addr_4/vsrc/addr_4.v", 2, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/addr/addr_4/vsrc/addr_4.v", 2, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/addr/addr_4/vsrc/addr_4.v", 2, "", "NBA region did not converge.");
            }
