...
void VFSM_top___024root__trace_chg_sub_0(VFSM_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VFSM_top___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFSM_top___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VFSM_top___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VFSM_top___024root__trace_chg_sub_0(VFSM_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VFSM_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFSM_top___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgBit(oldp+4,(vlSelf->out));
    bufp->chgCData(oldp+5,(vlSelf->FSM_top__DOT__out_temp),4);
}

void VFSM_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFSM_top___024root__trace_cleanup\n"); );
    // Init
    VFSM_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VFSM_top___024root*>(voidSelf);
    VFSM_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
