...
VL_INLINE_OPT void Vmux21___024root___ico_sequent__TOP__0(Vmux21___024root* vlSelf) {
    ...
    // Body
    vlSelf->out = (((~ (IData)(vlSelf->s)) & (IData)(vlSelf->a)) 
...
#endif
                VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/mux/vsrc/mux21.v", 18, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/mux/vsrc/mux21.v", 18, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/mike/project/ysyx-workbench/npc/nvboard-verilog-pratice/mux/vsrc/mux21.v", 18, "", "NBA region did not converge.");
            }
