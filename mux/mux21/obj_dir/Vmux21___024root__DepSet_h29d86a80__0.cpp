...
#endif
                VL_FATAL_MT("mux21.v", 18, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("mux21.v", 18, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("mux21.v", 18, "", "NBA region did not converge.");
            }
