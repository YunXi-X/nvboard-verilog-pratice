...
VL_ATTR_COLD void Vmux21___024root__trace_init_sub__TOP__0(Vmux21___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,"s", false,-1);
    tracep->declBit(c+4,"out", false,-1);
    tracep->declBit(c+5,"s_n", false,-1);
    tracep->declBit(c+6,"temp1", false,-1);
    tracep->declBit(c+7,"temp2", false,-1);
...
VL_ATTR_COLD void Vmux21___024root__trace_full_sub_0(Vmux21___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,((1U & (~ (IData)(vlSelf->s)))));
    bufp->fullBit(oldp+6,(((~ (IData)(vlSelf->s)) & (IData)(vlSelf->a))));
    bufp->fullBit(oldp+7,(((IData)(vlSelf->b) & (IData)(vlSelf->s))));
}
