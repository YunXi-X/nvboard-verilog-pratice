...
VL_INLINE_OPT void Vmux41___024root___ico_sequent__TOP__0(Vmux41___024root* vlSelf) {
    ...
    vlSelf->out = ((2U & (IData)(vlSelf->Y)) ? ((1U 
                                                 ...
                                                 ? (IData)(vlSelf->X_3)
                                                 : (IData)(vlSelf->X_2))
                    : ((1U & (IData)(vlSelf->Y)) ? (IData)(vlSelf->X_1)
                        : (IData)(vlSelf->X_0)));
}
...
#endif
                VL_FATAL_MT("/home/mike/project/nvboard-verilog-pratice/mux/mux41/vsrc/mux41.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/mike/project/nvboard-verilog-pratice/mux/mux41/vsrc/mux41.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/mike/project/nvboard-verilog-pratice/mux/mux41/vsrc/mux41.v", 1, "", "NBA region did not converge.");
            }
...
void Vmux41___024root___eval_debug_assertions(Vmux41___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->X_0 & 0xfeU))) {
        Verilated::overWidthError("X_0");}
    if (VL_UNLIKELY((vlSelf->X_1 & 0xfeU))) {
        Verilated::overWidthError("X_1");}
    if (VL_UNLIKELY((vlSelf->X_2 & 0xfeU))) {
        Verilated::overWidthError("X_2");}
    if (VL_UNLIKELY((vlSelf->X_3 & 0xfeU))) {
        Verilated::overWidthError("X_3");}
}
#endif  // VL_DEBUG
