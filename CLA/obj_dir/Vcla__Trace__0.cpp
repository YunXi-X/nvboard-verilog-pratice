...
void Vcla___024root__trace_chg_sub_0(Vcla___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vcla___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcla___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vcla___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vcla___024root__trace_chg_sub_0(Vcla___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vcla__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcla___024root__trace_chg_sub_0\n"); );
    // Init
